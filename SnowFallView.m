...
#define kDefaultFlakeFileName @"/Library/MobileSubstrate/DynamicLibraries/SnowBoardFlake.png"
...
-(void)createFlakes {	
	...
	UIImage *flakeImg = [UIImage imageWithContentsOfFile:flakeFileName];
